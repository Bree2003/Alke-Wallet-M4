...
public class ChileanCurrency implements ConvertCurrency{
	...
	public void addCurrency() {
		currencyExchange.add(0.0011);
		currencyExchange.add(1.0);
		currencyExchange.add(0.00098);
		currencyExchange.add(0.00083);
		currencyExchange.add(0.16);
		currencyExchange.add(1.44);
    }
