...
public class PoundSterlingCurrency implements ConvertCurrency{

	private List<Double> currencyExchange = new ArrayList<>();
	private CurrencyList currencies = new CurrencyList();
	private Scanner s;
	
	public PoundSterlingCurrency(Scanner s) {
		this.s = s;
		addCurrency();
	}
	@Override
	...
	public void addCurrency() {
		currencyExchange.add(1.25);
		currencyExchange.add(1198.92);
		currencyExchange.add(1.17);
		currencyExchange.add(1.0);
		currencyExchange.add(192.29 );
		currencyExchange.add(1724.07);
