...
public class SouthKoreanWonCurrency implements ConvertCurrency{

	private List<Double> currencyExchange = new ArrayList<>();
	private CurrencyList currencies = new CurrencyList();
	private Scanner s;
	
	public SouthKoreanWonCurrency(Scanner s) {
		this.s = s;
		addCurrency();
	}
	@Override
	...
	public void addCurrency() {
		currencyExchange.add(0.00073);
		currencyExchange.add(0.70);
		currencyExchange.add(0.00068);
		currencyExchange.add(0.00058);
		currencyExchange.add(0.11);
