...
public class JapaneseYenCurrency implements ConvertCurrency{
	...
	public void addCurrency() {
		currencyExchange.add(0.0065);
		currencyExchange.add(6.23);
		currencyExchange.add(0.0061);
		currencyExchange.add(0.0052);
		currencyExchange.add(1.0);
		currencyExchange.add(8.97);
